...
//    protected static List<IntentWrapperUtils> sIntentWrapperList;

    public static List<IntentWrapperUtils> getIntentWrapperList(Context context) {
//        if (sIntentWrapperUtilsList == null) {

        List<IntentWrapperUtils> sIntentWrapperUtilsList = new ArrayList<>();
//            sIntentWrapperUtilsList = new ArrayList<>();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            if (!ignoringBatteryOptimizations) {
                ...
                sIntentWrapperUtilsList.add(new IntentWrapperUtils(dozeIntent, DOZE));
            }
        }
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(huaweiIntent, HUAWEI));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(huaweiGodIntent, HUAWEI_GOD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(xiaomiIntent, XIAOMI));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(xiaomiGodIntent, XIAOMI_GOD));

        //三星 5.0/5.1 自启动应用程序管理
        Intent samsungLIntent = context.getPackageManager().getLaunchIntentForPackage("com.samsung.android.sm");
        if (samsungLIntent != null)
            sIntentWrapperUtilsList.add(new IntentWrapperUtils(samsungLIntent, SAMSUNG_L));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(samsungMIntent, SAMSUNG_M));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(meizuIntent, MEIZU));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(meizuGodIntent, MEIZU_GOD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(oppoIntent, OPPO));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(oppoOldIntent, OPPO_OLD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(vivoGodIntent, VIVO_GOD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(gioneeIntent, GIONEE));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(letvIntent, LETV));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(letvGodIntent, LETV_GOD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(coolpadIntent, COOLPAD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(lenovoIntent, LENOVO));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(lenovoGodIntent, LENOVO_GOD));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(zteIntent, ZTE));
        ...
        sIntentWrapperUtilsList.add(new IntentWrapperUtils(zteGodIntent, ZTE_GOD));
//        }
        return sIntentWrapperUtilsList;
    }
     ...
     * 处理白名单.
     *
     * @return 弹过框的 IntentWrapperUtils.
     */
    @NonNull
    public static List<IntentWrapperUtils> whiteListMatters(final Activity a, String reason) {
        List<IntentWrapperUtils> showed = new ArrayList<>();
        if (reason == null) reason = "核心服务的持续运行";
        List<IntentWrapperUtils> intentWrapperUtilsList = getIntentWrapperList(a);
        for (final IntentWrapperUtils iw : intentWrapperUtilsList) {
    ...
    protected IntentWrapperUtils(Intent intent, int type) {
        this.intent = intent;
        this.type = type;
    }
